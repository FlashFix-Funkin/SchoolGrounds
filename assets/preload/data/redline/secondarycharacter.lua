...
name_of_character_xml = 'roc2'
name_of_character = 'roc2'
name_of_notetype = 'No Animation'
name_of_notetype2 = 'No Animation' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function onCreate()
	...
	setObjectOrder(name_of_character, getObjectOrder(name_of_character) - 17)
