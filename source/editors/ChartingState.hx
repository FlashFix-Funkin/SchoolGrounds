...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['HUD Fade', '1 gets rid of the hud \n0 adds the hud back'],
		...
		['Set Letterbox Size', "Value 1: Distance from Edge\nValue 2: The duration in Seconds"],
	...
	**/
	...
	function loadSong():Void
	{
		...
		var suffix:String = PlayState.storyDifficulty == 2 ? "-erect" : '';
		var file:Dynamic = Paths.voices(currentSongName + suffix);
		vocals = new FlxSound();
	...
	function generateSong() {
		var suffix:String = PlayState.storyDifficulty == 2 ? "-erect" : '';
		FlxG.sound.playMusic(Paths.inst(currentSongName + suffix), 0.6/*, false*/);
